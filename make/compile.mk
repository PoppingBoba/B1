...
MODULE_OBJCPPSRCS := $(filter %.mm,$(MODULE_SRCS))
...
MODULE_OBJCPPOBJS := $(call TOBUILDDIR,$(patsubst %.mm,%.mm.o,$(MODULE_OBJCPPSRCS)))
...
$(MODULE_OBJCPPOBJS) $(MODULE_FLOAT_OBJCPPOBJS) $(MODULE_ARM_OBJCPPOBJS): $(BUILDDIR)/%.mm.o: %.mm $(MODULE_SRCDEPS)
	@$(MKDIR)
	@$(MKDIR_COMPILE_DB)
	$(info compiling $<)
