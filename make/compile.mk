...
$(MODULE_OBJCOBJS) $(MODULE_FLOAT_OBJCOBJS) $(MODULE_ARM_OBJCOBJS): $(BUILDDIR)/%.m.o: %.m $(MODULE_SRCDEPS)
	@$(MKDIR)
	$(info compiling $<)
	$(NOECHO)$(CC) $(GLOBAL_OPTFLAGS) $(MODULE_OPTFLAGS) $(GLOBAL_COMPILEFLAGS) $(ARCH_COMPILEFLAGS) $(MODULE_COMPILEFLAGS) $(GLOBAL_CFLAGS) $(ARCH_CFLAGS) $(MODULE_CFLAGS) $(GLOBAL_INCLUDES) $(MODULE_INCLUDES) -fobjc-runtime=gcc -fno-objc-arc -fno-objc-exceptions -c $< -MD -MP -MT $@ -MF $(@:%o=%d) -o $@

$(MODULE_OBJCPPOBJS) $(MODULE_FLOAT_OBJCPPOBJS) $(MODULE_ARM_OBJCPPOBJS): $(BUILDDIR)/%.cc.o: %.cc $(MODULE_SRCDEPS)
	@$(MKDIR)
	$(info compiling $<)
	$(NOECHO)$(CC) $(GLOBAL_OPTFLAGS) $(MODULE_OPTFLAGS) $(GLOBAL_COMPILEFLAGS) $(ARCH_COMPILEFLAGS) $(MODULE_COMPILEFLAGS) $(GLOBAL_CPPFLAGS) $(ARCH_CPPFLAGS) $(MODULE_CPPFLAGS) $(GLOBAL_INCLUDES) $(MODULE_INCLUDES) -fobjc-runtime=gcc -fno-objc-arc -fno-objc-exceptions -c $< -MD -MP -MT $@ -MF $(@:%o=%d) -o $@
