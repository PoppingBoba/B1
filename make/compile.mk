...
MODULE_OBJS := $(MODULE_COBJS) $(MODULE_CPPOBJS) $(MODULE_OBJCOBJS) $(MODULE_CCOBJS) $(MODULE_ASMOBJS)
...
$(MOUDLE_OBJS): MODULE_OBJCFLAGS:=$(MODULE_OBJCFLAGS)
...
$(MODULE_OBJCOBJS) $(MODULE_FLOAT_OBJCOBJS) $(MODULE_ARM_OBJCOBJS): $(BUILDDIR)/%.m.o: %.m $(MODULE_SRCDEPS)
	@$(MKDIR)
	$(info compiling $<)
	$(NOECHO)$(CC)  $(GLOBAL_OPTFLAGS) $(MODULE_OPTFLAGS) $(GLOBAL_COMPILEFLAGS) $(ARCH_COMPILEFLAGS) $(MODULE_COMPILEFLAGS) $(GLOBAL_OBJCFLAGS) $(ARCH_OBJCFLAGS) $(MODULE_OBJCFLAGS) $(GLOBAL_INCLUDES) $(MODULE_INCLUDES) -fobjc-runtime=gcc -fno-objc-arc -fno-objc-exceptions -c $< -MD -MP -MT $@ -MF $(@:%o=%d) -o $@
