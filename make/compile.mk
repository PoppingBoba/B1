...
$(MODULE_OBJCOBJS) $(MODULE_FLOAT_OBJCOBJS) $(MODULE_ARM_OBJCOBJS): $(BUILDDIR)/%.m.o: %.m $(MODULE_SRCDEPS)
	@$(MKDIR)
	$(info compiling $<)
	$(NOECHO)$(CC) $(GLOBAL_OPTFLAGS) $(MODULE_OPTFLAGS) $(GLOBAL_COMPILEFLAGS) $(ARCH_COMPILEFLAGS) $(MODULE_COMPILEFLAGS) $(GLOBAL_OBJCFLAGS) $(ARCH_OBJCFLAGS) $(MODULE_OBJCFLAGS) $(GLOBAL_INCLUDES) $(MODULE_INCLUDES) -c $< -MD -MP -MT $@ -MF $(@:%o=%d) -o $@
